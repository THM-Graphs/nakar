export class Color {
  /**
   * Bestimmt ob eine Farbe hell ist (true) oder dunkel (false)
   * @param color - Hexadezimaler Farbwert (3 oder 6 Stellen, mit '#' Prefix)
   * @returns true wenn die Farbe hell ist (schwarze Schrift empfohlen), false wenn dunkel (weiße Schrift empfohlen)
   */
